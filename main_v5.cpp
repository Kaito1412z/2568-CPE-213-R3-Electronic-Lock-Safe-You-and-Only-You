  ...
  if (safeislock == true)
  {
    ...
    if (millis() - lastDebounceEnter > debounceEnter)
    {
      ...
      for (int i = 0; i <= 10; i++)
      {
        ...
        oled.fillRect(74, 15, 4, 15 - i, WHITE);
...
void loop()
{
  ...
  if (CurrentState == 0 && enter == true)
  {
    UnlockAnimation();
  }
  else if (CurrentState == 0 && enter == false)
  {
    unlock(); // display
  }

  else if (CurrentState == 1 && enter == true)
  {
    lockAnimation(); // display
  }
  else if (CurrentState == 1 && enter == false)
  {
    locked(); // display
  }
